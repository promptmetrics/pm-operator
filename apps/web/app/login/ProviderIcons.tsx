// Inline provider marks for the OAuth buttons on the auth screens. Inlined as
// SVG rather than pulled from an icon package because lucide-react dropped brand
// glyphs, and a remote sprite would add a request to the auth critical path.
// Decorative only — every call site labels the button with visible text.

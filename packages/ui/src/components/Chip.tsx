  ...
  ({ active = false, swatch, className, children, ...props }, ref) => {
    return (
      <button
        ...
        aria-pressed={active}
        className={cn(
          "inline-flex h-[var(--pm-control-h)] items-center gap-1.5 rounded-[var(--pm-radius-pill)] border px-3 text-sm transition-colors focus:outline-none focus-visible:shadow-[var(--pm-focus)] disabled:pointer-events-none disabled:opacity-60",
          active
